...
/**
 * Shared support for read-oriented single-thread benchmarks. It preloads a
 * fixed number of entries and provides helpers to pick keys for hit or miss
 * scenarios.
 */
public abstract class AbstractSingleThreadReadBenchmarkSupport
        extends AbstractSingleThreadStorageBenchmark {

...
public class FileUtils {
	...
	/**
	 * Recursively deletes the directory (and all files/subdirectories) at the given
	 * location, if it exists.
	 *
	 * @param dir the {@link File} pointing to the directory to delete
	 * @throws RuntimeException if an I/O error occurs or if the path exists but is
	 *                          not a directory
	 */

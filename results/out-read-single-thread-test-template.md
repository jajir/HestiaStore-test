...
![Single-thread read benchmark chart](../images/out-read-single-thread.svg)
...
![Single-thread read latency percentile chart](../images/out-read-single-thread-percentiles.svg)

...
![Single-thread write benchmark chart](../images/out-write-single-thread.svg)
...
![Single-thread write latency percentile chart](../images/out-write-single-thread-percentiles.svg)

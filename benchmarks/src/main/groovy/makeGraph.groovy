...
File inputFile = new File(baseDir, 'results/table.json')
File outputFile = new File(baseDir, 'results/table.svg')
...
def data = new JsonSlurper().parse(inputFile)
if (!(data instanceof List) || data.isEmpty()) {
    System.err.println "Input does not contain an array of benchmark rows"
    System.exit(1)
}
